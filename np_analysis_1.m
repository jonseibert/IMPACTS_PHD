...
if(local)
    ...
    path_to_borders = './downloaded_code';
    if(exp_choice == 1)
        input_path_base = 'C:/Users/JonSe/Documents/Actual Documents/PSU/IMPACTS/Code/input/wrf_data/2020/AIR';
    elseif(exp_choice == 2)
        input_path_base = 'C:/Users/JonSe/Documents/Actual Documents/PSU/IMPACTS/Code/input/wrf_data/2020/CONV';
    end
else
    mode = 'server';
    ...
    path_to_borders = '/storage/home/jjs5895/projects/IMPACTS/code/downloaded_code'; % Specify path to borders.m
    if(exp_choice == 1)
        input_path_base = '/storage/home/jjs5895/projects/IMPACTS/data/2020/AIRCFT/fc';
    elseif(exp_choice == 2)
        input_path_base = '/storage/home/jjs5895/projects/IMPACTS/data/2020/CONV/fc';
    end
end
...
if(~use_obs)
    ...
    load(sprintf('%s/%s',intermediate_path,'latlon_gis_trim.mat'),'lon_gis_trim','lat_gis_trim','n_idx','s_idx','e_idx','w_idx'); % Load in preestablished latlon values
    lon = lon_gis_trim;
    lat = lat_gis_trim;
    num_members = 1;
end
...
sum_np = zeros(dims(1),dims(2),num_perms);
    ...
    for member_idx = 1:num_members
        ...
        if(use_obs)
            ...
            data = data_gis(s_idx:1:n_idx,w_idx:1:e_idx); % Trim down to WRF domain
        elseif(use_base_ref) % UNDER CONSTRUCTION
        ...
        if(~use_base_ref && ~use_obs)
            data = align_data(data,transpose_data,flip_data,z_composite_data,n_idx,s_idx,e_idx,w_idx);
        end
        ...
        for cutoff = cut_min:cut_step:cut_max % For each cutoff value:
            ...
            for roi = roi_min:roi_step:roi_max % For each ROI value: 
                ...
                if(plot_mean_only)
                    roi_idx = roi_idx + 1;
                    continue;
                elseif(plot_first_and_mean_only && member_idx ~= 1)
                    roi_idx = roi_idx + 1;
                    continue;
                end
